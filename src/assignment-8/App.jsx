      ...
      <main className="mx-auto w-full max-w-6xl flex-1 px-4">
        ...
        <div className="divide-y divide-zinc-200 dark:divide-zinc-800">
          ...
          <ClaimCard
            ...
            claim={`${ERAS.length} eras, ${NODES.length} nodes, strictly by the date each mechanism first appeared in public (arXiv v1, or the blog / Reddit post / model release when that came first — both dates shown when they differ). Not the order they were taught, not grouped by family. Each card says what problem existed at that moment, what the idea was, what it buys, what it costs, and when you would actually pick it. Big cards open a live visual; small cards expand. Filter to the instructor's 17, by family, or by the bill attacked.`}
