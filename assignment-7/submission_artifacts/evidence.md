...
- [PASS] `frozen_embeddings_match_recomputed_hashes` — {'n_frozen_runs': 51}
...
- [PASS] `claimB_probe_localizes_failure_to_trunk` — {'kron_input': 0.42778793418647165, 'kron_hidden': 0.6857032518467508, 'learned_input': 0.8167052459438802, 'n_probes': 10}
