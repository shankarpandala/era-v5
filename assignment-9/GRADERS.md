...
| 7 | peak memory, plain vs chunked CE | 2,378.9 MiB vs 181.2 MiB = **13.1×** at V = 50,257 |

**Part 2:** t+2 head on the same trunk — held-out L1 2.5924, L2 2.9745, sum 5.5668. The
gap starts at zero (both heads ignorant), opens with training, never closes held-out
(+0.38 nats), and narrows on the memorizable train split: conditional entropy, measured.
